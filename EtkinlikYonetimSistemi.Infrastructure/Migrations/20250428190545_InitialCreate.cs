    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IlgiAlaniKullanici", x => new { x.IlgiAlanlariId, x.KullanicilarId });
                    table.ForeignKey(
                        name: "FK_IlgiAlaniKullanici_IlgiAlanlari_IlgiAlanlariId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SatinAlimlar", x => x.SatinAlimId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SatinAlimlar_Kullanicilar_KullaniciId1",
            ...
            migrationBuilder.InsertData(
                table: "IlgiAlanlari",
                columns: new[] { "Id", "Aciklama", "Ad", "AnaKategoriMi", "BasePrice", "UpdatedDate", "UstKategoriId" },
                values: new object[,]
                {
                    ...
                    { 11, "Rock müzik etkinlikleri", "Rock", false, 0m, null, 1 },
                    { 12, "Pop müzik etkinlikleri", "Pop", false, 0m, null, 1 },
                    { 13, "Klasik müzik etkinlikleri", "Klasik", false, 0m, null, 1 },
                    { 14, "Halk müziği etkinlikleri", "Halk Müzigi", false, 0m, null, 1 },
                    { 15, "Metal müzik etkinlikleri", "Metal", false, 0m, null, 1 },
                    { 16, "Rap müzik etkinlikleri", "Rap", false, 0m, null, 1 },
                    { 17, "DJ etkinlikleri", "DJ", false, 0m, null, 1 },
                    { 21, "Futbol maçları  ", "Futbol", false, 0m, null, 2 },
                    { 22, "Basketbol maçları", "Basketbol", false, 0m, null, 2 },
                    { 23, "Voleybol maçları", "Voleybol", false, 0m, null, 2 },
                    { 24, "Formula 1 yarışları", "Formula 1", false, 0m, null, 2 },
                    { 25, "Doğa yürüyüşleri", "Doğa Yürüyüşü", false, 0m, null, 2 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SatinAlimlar_KullaniciId1",
                table: "SatinAlimlar",
                column: "KullaniciId1");
